...
export declare class Type implements flatbuffers.IUnpackableObject<TypeT> {
    ...
    static add_base_type(builder: flatbuffers.Builder, baseType: BaseType): void;
    ...
    static add_fixed_length(builder: flatbuffers.Builder, fixedLength: number): void;
    static add_base_size(builder: flatbuffers.Builder, baseSize: number): void;
    static add_element_size(builder: flatbuffers.Builder, elementSize: number): void;
