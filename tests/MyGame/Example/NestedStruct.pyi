...
class NestedStruct(object):
  ...
  d: typing.List[int]
  @classmethod
  def InitFromBuf(cls, buf: bytes, pos: int) -> NestedStruct: ...
  @classmethod
  def InitFromPackedBuf(cls, buf: bytes, pos: int = 0) -> NestedStruct: ...
  @classmethod
  def InitFromObj(cls, nestedStruct: NestedStruct) -> NestedStruct: ...
