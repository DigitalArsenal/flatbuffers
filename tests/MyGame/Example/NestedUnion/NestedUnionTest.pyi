...
import typing
from Any import Any
from NestedUnionTest import NestedUnionTest
...
class NestedUnionTest(object):
  ...
  data: typing.Union[None, Vec3, TestSimpleTableWithEnum]
  id: int
  @classmethod
  def InitFromBuf(cls, buf: bytes, pos: int) -> NestedUnionTest: ...
  @classmethod
  def InitFromPackedBuf(cls, buf: bytes, pos: int = 0) -> NestedUnionTest: ...
  @classmethod
  def InitFromObj(cls, nestedUnionTest: NestedUnionTest) -> NestedUnionTest: ...
