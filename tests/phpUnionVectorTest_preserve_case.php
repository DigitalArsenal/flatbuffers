...
require join(DIRECTORY_SEPARATOR, array(dirname(__FILE__), "php_preserve_case", 'Attacker.php'));
require join(DIRECTORY_SEPARATOR, array(dirname(__FILE__), "php_preserve_case", 'BookReader.php'));
require join(DIRECTORY_SEPARATOR, array(dirname(__FILE__), "php_preserve_case", 'Character.php'));
require join(DIRECTORY_SEPARATOR, array(dirname(__FILE__), "php_preserve_case", 'Movie.php'));
