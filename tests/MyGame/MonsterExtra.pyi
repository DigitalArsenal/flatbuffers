...
import flatbuffers
import typing
from MonsterExtra import MonsterExtra
...
class MonsterExtra(object):
  ...
  @classmethod
  def InitFromBuf(cls, buf: bytes, pos: int) -> MonsterExtra: ...
  @classmethod
  def InitFromPackedBuf(cls, buf: bytes, pos: int = 0) -> MonsterExtra: ...
  @classmethod
  def InitFromObj(cls, monsterExtra: MonsterExtra) -> MonsterExtra: ...
  def _UnPack(self, monsterExtra: MonsterExtra) -> None: ...
  def Pack(self, builder: flatbuffers.Builder) -> None: ...
  def __eq__(self, other: MonsterExtra) -> bool: ...
