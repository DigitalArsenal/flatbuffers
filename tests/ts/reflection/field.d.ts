...
export declare class Field implements flatbuffers.IUnpackableObject<FieldT> {
    ...
    static add_default_integer(builder: flatbuffers.Builder, defaultInteger: bigint): void;
    static add_default_real(builder: flatbuffers.Builder, defaultReal: number): void;
