...
export declare class Monster implements flatbuffers.IUnpackableObject<MonsterT> {
    ...
    static add_test_type(builder: flatbuffers.Builder, testType: Any): void;
    ...
    static add_testhashs32_fnv1(builder: flatbuffers.Builder, testhashs32Fnv1: number): void;
    static add_testhashu32_fnv1(builder: flatbuffers.Builder, testhashu32Fnv1: number): void;
    static add_testhashs64_fnv1(builder: flatbuffers.Builder, testhashs64Fnv1: bigint): void;
    static add_testhashu64_fnv1(builder: flatbuffers.Builder, testhashu64Fnv1: bigint): void;
    static add_testhashs32_fnv1a(builder: flatbuffers.Builder, testhashs32Fnv1a: number): void;
    static add_testhashu32_fnv1a(builder: flatbuffers.Builder, testhashu32Fnv1a: number): void;
    static add_testhashs64_fnv1a(builder: flatbuffers.Builder, testhashs64Fnv1a: bigint): void;
    static add_testhashu64_fnv1a(builder: flatbuffers.Builder, testhashu64Fnv1a: bigint): void;
    ...
    static add_vector_of_longs(builder: flatbuffers.Builder, vectorOfLongsOffset: flatbuffers.Offset): void;
    ...
    static add_vector_of_doubles(builder: flatbuffers.Builder, vectorOfDoublesOffset: flatbuffers.Offset): void;
    ...
    static add_parent_namespace_test(builder: flatbuffers.Builder, parentNamespaceTestOffset: flatbuffers.Offset): void;
    static add_vector_of_referrables(builder: flatbuffers.Builder, vectorOfReferrablesOffset: flatbuffers.Offset): void;
    ...
    static add_single_weak_reference(builder: flatbuffers.Builder, singleWeakReference: bigint): void;
    static add_vector_of_weak_references(builder: flatbuffers.Builder, vectorOfWeakReferencesOffset: flatbuffers.Offset): void;
    ...
    static add_vector_of_strong_referrables(builder: flatbuffers.Builder, vectorOfStrongReferrablesOffset: flatbuffers.Offset): void;
    ...
    static add_co_owning_reference(builder: flatbuffers.Builder, coOwningReference: bigint): void;
    static add_vector_of_co_owning_references(builder: flatbuffers.Builder, vectorOfCoOwningReferencesOffset: flatbuffers.Offset): void;
    ...
    static add_non_owning_reference(builder: flatbuffers.Builder, nonOwningReference: bigint): void;
    static add_vector_of_non_owning_references(builder: flatbuffers.Builder, vectorOfNonOwningReferencesOffset: flatbuffers.Offset): void;
    ...
    static add_any_unique_type(builder: flatbuffers.Builder, anyUniqueType: AnyUniqueAliases): void;
    static add_any_unique(builder: flatbuffers.Builder, anyUniqueOffset: flatbuffers.Offset): void;
    static add_any_ambiguous_type(builder: flatbuffers.Builder, anyAmbiguousType: AnyAmbiguousAliases): void;
    static add_any_ambiguous(builder: flatbuffers.Builder, anyAmbiguousOffset: flatbuffers.Offset): void;
    static add_vector_of_enums(builder: flatbuffers.Builder, vectorOfEnumsOffset: flatbuffers.Offset): void;
    ...
    static add_signed_enum(builder: flatbuffers.Builder, signedEnum: Race): void;
    ...
    static add_scalar_key_sorted_tables(builder: flatbuffers.Builder, scalarKeySortedTablesOffset: flatbuffers.Offset): void;
    ...
    static add_native_inline(builder: flatbuffers.Builder, nativeInlineOffset: flatbuffers.Offset): void;
    static add_long_enum_non_enum_default(builder: flatbuffers.Builder, longEnumNonEnumDefault: bigint): void;
    static add_long_enum_normal_default(builder: flatbuffers.Builder, longEnumNormalDefault: bigint): void;
    static add_nan_default(builder: flatbuffers.Builder, nanDefault: number): void;
    static add_inf_default(builder: flatbuffers.Builder, infDefault: number): void;
    static add_positive_inf_default(builder: flatbuffers.Builder, positiveInfDefault: number): void;
    static add_infinity_default(builder: flatbuffers.Builder, infinityDefault: number): void;
    static add_positive_infinity_default(builder: flatbuffers.Builder, positiveInfinityDefault: number): void;
    static add_negative_inf_default(builder: flatbuffers.Builder, negativeInfDefault: number): void;
    static add_negative_infinity_default(builder: flatbuffers.Builder, negativeInfinityDefault: number): void;
    static add_double_inf_default(builder: flatbuffers.Builder, doubleInfDefault: number): void;
