...
class MonsterT(object):
    ...
    def _UnPack(self, monster):
        ...
        self.test = AnyCreator(self.test_type, monster.test())
        ...
        self.any_unique = AnyUniqueAliasesCreator(self.any_unique_type, monster.any_unique())
        self.any_ambiguous_type = monster.any_ambiguous_type()
        self.any_ambiguous = AnyAmbiguousAliasesCreator(self.any_ambiguous_type, monster.any_ambiguous())
